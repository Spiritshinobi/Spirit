...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Causs\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=555198377746:+555198377746\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '.','!','#'
blocked = []
limitawal = '999999999'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerG: '[❗] Spirit? Este é um recurso especial para o Spirit ❌',
					ownerB: '[❗] Spirit? Este é um recurso especial para o Spirit ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de Spirit. Registre-se para fazer amizade com o bot Causs por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar Causs|17\n\n──「 CAUSS BOT 」──`,
			...
			const ownerNumber = ["555198377746@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"555198377746@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["555198377746@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["555198377746@s.whatsapp.net"]//ubah nomor lo
			const premium = ["555198377746@s.whatsapp.net","558296156440@s.whatsapp.net"] 
